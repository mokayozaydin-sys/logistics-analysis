...
## 📈 Visual Dashboards (Sample Outputs)

Below are the automated dashboards generated by the ETL pipeline based on the maritime dataset:

### 1. Cost Optimization & Origin Analytics
![Origin Cost Report](01_origin_cost_report.png)
![Origin Lead Time Report](02_origin_time_report.png)

### 2. Route & Destination Intelligence
![Destination Density Report](03_destination_density_report.png)
![Popular Routes Report](04_popular_routes_report.png)

### 3. Financial Breakdown
![Cost Breakdown Pie Chart](05_cost_breakdown_pie_chart.png)
